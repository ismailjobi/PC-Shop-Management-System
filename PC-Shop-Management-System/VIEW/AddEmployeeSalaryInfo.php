...
<body>
    ...
    <div class="body_border">
        <form action="../CONTROLER/Salary_info_Oparetion.php" method="post" novalidate
            onsubmit=" return isvalidateSalaryForm(this)">
                                ...
                                <table align="right">
                                    <th>
                                                        ...
                                                        if ($_SESSION['userExist']) {
                                                            if (isset($_SESSION['done'])) {
                                                                if ($_SESSION['done']) {
                                                                    ...
                                                                    unset($_SESSION['employeeId'], $_SESSION['salary']);
                                                                }
                                                            }
                                                        } else {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b>:</b>
                                                <input type="text" name="salary" id="salary" value="<?php echo
                                                    isset($_SESSION['salary']) ? $_SESSION['salary'] : "" ?>"><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><span id="salary_msg" class="errorMsg"></span></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>
                                                ...
                                                if (isset($_SESSION['Submited'])) {
                                                    if ($_SESSION['Submited']) {
                                                        if (isset($_SESSION['salary_empty'])) {
                                                            if ($_SESSION['salary_empty']) {
                                                                echo '<p class ="errorMsg">*Please enter Employee Salary.</p>';
                                                            }
                                                        }
                                                    }
                                                }
                                        ...
                                        <tr align="center">
                                            ...
                                            <td>
                                                <a href="Salary_Sheet.php" class="backButton">
                                                    <table>
                                                        <th>
                                                            <tr>
    ...
    <script src="SalaryInfo.js"></script>

</body>

</html>
<?php
unset($_SESSION['done'], $_SESSION['employeeId_empty'], $_SESSION['salary_empty'], $_SESSION['userExist']);
?>