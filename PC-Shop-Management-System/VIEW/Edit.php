...
if (isset($_GET['id'])) {
    ...
    $id = isset($_SESSION['editIdr']) ? $_SESSION['editIdr'] : "";
}
...
<body>
    ...
    <div class="body_border">
        <form action="../CONTROLER/EditOparetion.php" method="post" enctype="multipart/form-data" novalidate 
        onsubmit=" return isvalidateUpdateForm(this)">
            <div align="center">
                <table>
                    <th>
                    <td>
                                                            ...
                                                            if (isset($_SESSION['SubmitedReg'])) {
                                                                if ($_SESSION['SubmitedReg']) {
                                                                    if (isset($_SESSION['fName_empty']) || isset($_SESSION['Nid_empty']) || isset($_SESSION['lName_empty']) || isset($_SESSION['faName_empty']) || isset($_SESSION['mName_empty']) || isset($_SESSION['dob_empty']) || isset($_SESSION['email_empty']) || isset($_SESSION['phone_empty']) || isset($_SESSION['address_empty']) || isset($_SESSION['passwordRe_empty'])) {
                                                                        if ($_SESSION['fName_empty'] || $_SESSION['Nid_empty'] || $_SESSION['lName_empty'] || $_SESSION['faName_empty'] || $_SESSION['mName_empty'] || $_SESSION['dob_empty'] || $_SESSION['email_empty'] || $_SESSION['phone_empty'] || $_SESSION['address_empty'] || $_SESSION['passwordRe_empty']) {
                                                                            ...
                                                                            if (isset($_SESSION['done'])) {
                                                                                if ($_SESSION['done']) {
                                                                                    echo '<p align="center" class ="errorMsg"><b>Successfully Update Information.</b></p>';
                                                        ...
                                                        if (isset($_SESSION['Exist_img'])) {
                                                            ...
                                                            if (isset($_SESSION['invalid_img'])) {
                                                                ...
                                                                if ($_SESSION['valid_img']) {
                                                                    echo '<span class ="errorMsg">Successfully Added.</span>';
                                                                }
                                                            }
